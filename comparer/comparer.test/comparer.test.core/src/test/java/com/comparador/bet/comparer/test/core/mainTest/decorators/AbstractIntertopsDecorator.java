 ...
 */
public abstract class AbstractIntertopsDecorator extends
		AbstractTemplateMainTest {

	/** The Constant XML_LOCATION. */
	private static final String INTERTOPS_XML_LOCATION_SHORT = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\intertopsCompletoTest.xml";
	
	
	
	private static final Integer bookmakerOrder = 14;
	
	private static final BigInteger idBookmaker = new BigInteger("69");
	...
	protected List<BeanBookmaker> getBookmakersData() {
		...
		beanBookmaker.setXmlLocation(INTERTOPS_XML_LOCATION_SHORT);
