 ...
 */
public abstract class AbstractYouWinDecorator extends
	...
	private static final String BC_XML_LOCATION_SHORT = getProjectDir()
			...
			+ "\\test\\core\\xmlReaders\\youwinCompletoTest.xml";
	
	private static final Integer bookmakerOrder = 25;
	
	private static final BigInteger idBookmaker = new BigInteger("106");
