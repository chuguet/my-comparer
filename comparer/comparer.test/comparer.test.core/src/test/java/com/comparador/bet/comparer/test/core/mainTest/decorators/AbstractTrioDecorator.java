...
/**
 * The Class AbstractTrioDecorator.
 */
public abstract class AbstractTrioDecorator extends
	...
	private static final String BC_XML_LOCATION_SHORT = getProjectDir()
			...
			+ "\\test\\core\\xmlReaders\\triobetCompleto.xml";
	
	private static final Integer bookmakerOrder = 21;
	
	private static final BigInteger idBookmaker = new BigInteger("103");
	...
	private CfgBookmaker getBookmaker() {
		...
		bookmakerConfiguration.addBookmakerWebUrl(new CfgBookmakerWebUrl("http://www.Triobet.com"));
