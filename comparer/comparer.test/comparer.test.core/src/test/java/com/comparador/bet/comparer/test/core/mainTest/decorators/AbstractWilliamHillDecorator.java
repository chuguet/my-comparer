 ...
 */
public abstract class AbstractWilliamHillDecorator extends
	...
	private static final String BC_XML_LOCATION_SHORT_2 = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\williamhillCompleto2.xml";
	
	private static final Integer bookmakerOrder = 24;
	
	private static final BigInteger idBookmaker = new BigInteger("105");
