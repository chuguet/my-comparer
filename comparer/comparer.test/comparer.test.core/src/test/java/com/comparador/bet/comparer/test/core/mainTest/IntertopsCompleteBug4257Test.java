...
public final class IntertopsCompleteBug4257Test /*extends AbstractTemplateMainTest*/ {
...
//			+ "\\test\\core\\xmlReaders\\Intertops_Bug4257.xml";
//	
...
////			if (match.getXmlMatch().getName().equalsIgnoreCase("New York Knicks v Los Angeles Clippers")) {
...
////								assertTrue(bet.getXmlMarketBetOdd().getOdds().equals("1.9091"));
...
////								assertTrue(bet.getXmlMatchParticipant().getName().equals("Los Angeles Clippers"));
////								assertTrue(bet.getXmlMarketBetOdd().getOdds().equals("1.9091"));
////								assertTrue(atributo.getFirstValue() == 5.5);
////								assertEquals(null, atributo.getSecondValue());
////							} else {
...
////			if (match.getName(null).equals("New York Knicks vs Los Angeles	Clippers")) {
...
////							if (atributo.getAsianResult().equals(AsianResult.ONE)) {
////								assertTrue(bet.getBetOdd().getOdds().equals("1.9091"));
////								assertTrue(atributo.getFirstValue() == 5.5);
////								assertEquals(null, atributo.getSecondValue());
////							} else if (atributo.getAsianResult().equals(AsianResult.TWO)) {
////								assertTrue(bet.getBetOdd().getOdds().equals("1.9091"));
