 ...
 */
public abstract class AbstractLuckiaDecorator extends AbstractTemplateMainTest {
	...
	private static final String BC_XML_LOCATION_SHORT = getProjectDir() + "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\luckiaCompletoTestPremier.json";

	/** The Constant XML_LOCATION. */
	private static final String BC_XML_LOCATION_SHORT_1 = getProjectDir() + "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\luckiaCompletoTestChelseaWestHam.json";

	/** The Constant XML_LOCATION. */
	private static final String BC_XML_LOCATION_SHORT_2 = getProjectDir() + "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\luckiaCompletoTestBucksPistons.json";

	private static final Integer bookmakerOrder = 16;

	private static final BigInteger idBookmaker = new BigInteger("113");
	...
	protected List<BeanBookmaker> getBookmakersData() {
		...
		beanBookmaker.setXmlLocation(BC_XML_LOCATION_SHORT_1);
		beanBookmaker.setOrdenBookmaker(bookmakerOrder);
		beanBookmaker.setIdBookmaker(idBookmaker);
		beanBookmaker.setBookmaker(getBookmaker());
		beanBookmaker.setBeanAdditionalXmlInfoReader(new BeanAdditionalXmlInfoReader("", "", ""));
		...
		beanBookmaker = new BeanBookmaker();
		beanBookmaker.setXmlLocation(BC_XML_LOCATION_SHORT_2);
		beanBookmaker.setOrdenBookmaker(bookmakerOrder);
		beanBookmaker.setIdBookmaker(idBookmaker);
		beanBookmaker.setBookmaker(getBookmaker());
		beanBookmaker.setBeanAdditionalXmlInfoReader(new BeanAdditionalXmlInfoReader("", "", ""));
	...
	private CfgBookmaker getBookmaker() {
		...
		bookmakerConfiguration.addBookmakerWebUrl(new CfgBookmakerWebUrl("http://www.Luckia.es/"));
