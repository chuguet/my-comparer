 ...
 */
public abstract class AbstractPinnacleSportsDecorator extends
	...
	private static final String BC_XML_LOCATION_SHORT = getProjectDir()
			...
			+ "\\test\\core\\xmlReaders\\pinnaclesportsCompletoTest.xml";
	
	private static final Integer bookmakerOrder = 18;
