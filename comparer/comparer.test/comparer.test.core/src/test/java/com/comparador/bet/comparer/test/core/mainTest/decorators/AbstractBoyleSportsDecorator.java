 ...
 */
public abstract class AbstractBoyleSportsDecorator extends
	...
	private static final String BC_XML_LOCATION_SHORT = getProjectDir()
			...
			+ "\\test\\core\\xmlReaders\\boylesportsCompletoTest.xml";
	
	private static final Integer bookmakerOrder = 11;
	
	private static final BigInteger idBookmaker = new BigInteger("43");
