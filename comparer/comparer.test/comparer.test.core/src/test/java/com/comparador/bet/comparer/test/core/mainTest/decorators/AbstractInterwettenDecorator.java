...
/**
 * The Class AbstractNordicDecorator.
 */
public abstract class AbstractInterwettenDecorator extends
	...
	private static final Integer bookmakerOrder = 15;
	
	private static final BigInteger idBookmaker = new BigInteger("109");
