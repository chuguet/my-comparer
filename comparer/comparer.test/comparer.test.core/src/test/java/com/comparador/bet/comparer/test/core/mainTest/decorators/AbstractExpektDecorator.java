...
/**
 * The Class AbstractExpektDecorator.
 */
public abstract class AbstractExpektDecorator extends
	...
	private static final Integer bookmakerOrder = 12;
	
	private static final BigInteger idBookmaker = new BigInteger("56");
