 ...
 */
public abstract class AbstractBetOnlineDecorator extends
	...
	private static final String BETATHOME_XML_LOCATION_SHORT = getProjectDir()
			...
			+ "\\test\\core\\xmlReaders\\betonlineCompletoTest.xml";
	private static final String BETATHOME_XML_LOCATION_SHORT_2 = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\betonlineCompletoTest2.xml";
	private static final String BETATHOME_XML_LOCATION_SHORT_3 = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\test\\core\\xmlReaders\\betonlineCompletoTest3.xml";
		
	
	private static final Integer bookmakerOrder = 5;
	
	private static final BigInteger idBookmaker = new BigInteger("33");
	...
	protected List<BeanBookmaker> getBookmakersData() {
		...
		beanBookmaker.setXmlLocation(BETATHOME_XML_LOCATION_SHORT_2);
		beanBookmaker.setOrdenBookmaker(bookmakerOrder);
		beanBookmaker.setIdBookmaker(idBookmaker);
		beanBookmaker.setBookmaker(getBookmakerBH());
		beanBookmaker.setBeanAdditionalXmlInfoReader(new BeanAdditionalXmlInfoReader("", "", ""));
		bookmakersData.add(beanBookmaker);
		beanBookmaker = new BeanBookmaker();
		beanBookmaker.setXmlLocation(BETATHOME_XML_LOCATION_SHORT_3);
		beanBookmaker.setOrdenBookmaker(bookmakerOrder);
		beanBookmaker.setIdBookmaker(idBookmaker);
		beanBookmaker.setBookmaker(getBookmakerBH());
		beanBookmaker.setBeanAdditionalXmlInfoReader(new BeanAdditionalXmlInfoReader("", "", ""));
