...
import com.comparadorad.bet.comparer.synchro.reader.readerbookmaker.core.readers.expekt.XMLExpektFileReader;

/**
 * The Class XMLExpektFileReaderTest.
 */
public class XMLExpektFileReaderTest extends AbstractTest {

	/** The bet click reader. */
	@Inject
	private XMLExpektFileReader expektReader;

	private static final String EXPEKT_TIMEZONE = "GMT+0";
	...
	private static final String BC_XML_LOCATION_SHORT = getProjectDir()
			...
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt4.xml";

	/** The Constant XML_LOCATION. */
	private static final String EXPEKT_COMPLETO = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_completo.xml";

	/** The Constant EXPEKT_BAD_XML_LOCATION. */
	private static final String EXPEKT_BAD_XML_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_badXml.xml";

	/** The Constant XML_LOCATION. */
	private static final String BC_XML_LOCATION_FECHA_LP = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_FechaLargoPlazo.xml";

	private static final String HANDICAP_ASIATICO_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_handicap_asiatico.xml";

	private static final String UNO_X_DOS_HANDICAP_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_handicap_1x2.xml";

	private static final String UNO_X_DOS_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_1x2.xml";

	private static final String GANADOR_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_ganador.xml";

	private static final String GANADOR_DE_PARTIDO_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_ganador_de_partido.xml";

	private static final String BUG_3374_HANDICAP_ASIATICO_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_bug3374.xml";

	private static final String MAS_MENOS_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_mas_menos.xml";

	private static final String MAS_MENOS_SEVERAL_BETS_TEST_FILE_LOCATION = getProjectDir()
			+ "\\src\\test\\resources\\com\\comparadorad\\bet\\comparer"
			+ "\\synchro\\reader\\readerbookmaker\\core\\readers\\expekt\\expekt_mas_menos_severalBets.xml";
	...
	public void getBookmakerIdTest() {
		assertNotNull(expektReader.getBookmakerId());
		assertEquals(expektReader.getBookmakerId(),
				CfgBookmakerId.EXPEKT_COM_ID.objectId().toString());
	}
	 ...
	 */
	@Test
	public void expektReadTest() throws Exception {
		CfgBookmakerConfiguration bookmakerConfiguration = new CfgBookmakerConfiguration();
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, BC_XML_LOCATION_SHORT, bookmakerConfiguration,
				null);
	 ...
	 */
	@Test
	public void expektReadBigTest() throws Exception {
		CfgBookmakerConfiguration bookmakerConfiguration = new CfgBookmakerConfiguration();
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, EXPEKT_COMPLETO, bookmakerConfiguration,
				null);
	 ...
	 */
	@Test
	public void expektReadBadTest() throws Exception {
		CfgBookmakerConfiguration bookmakerConfiguration = new CfgBookmakerConfiguration();
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, EXPEKT_BAD_XML_LOCATION,
	...
	@Test
	public void expektReadFechaLPTest() throws Exception {
		CfgBookmakerConfiguration bookmakerConfiguration = new CfgBookmakerConfiguration();
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, BC_XML_LOCATION_FECHA_LP,
				bookmakerConfiguration, null);
	...
	public void handicapAsiaticoTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, HANDICAP_ASIATICO_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
	...
	public void masMenosSmallTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, MAS_MENOS_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
		...
		for (XmlMatch match : result) {
			...
			for (XmlMarket market : match.getXmlMarkets()) {
				...
				for (XmlMarketBet bet : market.getXmlMarketBets()) {
					...
					assertEquals(String.valueOf(40.5), attr.getTotalGoal().toString());
	...
	public void masMenosSeveralBetsTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, MAS_MENOS_SEVERAL_BETS_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
	...
	public void bug3374handicapAsiaticoTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, BUG_3374_HANDICAP_ASIATICO_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
	...
	public void UnoXDoshandicapSmallTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, UNO_X_DOS_HANDICAP_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
	...
	public void unoXDosSmallTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, UNO_X_DOS_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
	...
	public void ganadorDePartidoSmallTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, GANADOR_DE_PARTIDO_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
	...
	public void ganadorSmallTest() throws Exception {
		...
		bookmakerConfiguration.setTimeZone(EXPEKT_TIMEZONE);
		XmlBetFileReaderResult xmlrBetFileReaderResult = readXML(
				EXPEKT_READER, GANADOR_TEST_FILE_LOCATION,
				bookmakerConfiguration, null);
