 ...
 */
@Configuration
@PropertySource({ "classpath:/filter-config.properties" })
@ComponentScan({ "com.comparadorad.bet.comparer.synchro.reader.filter" })
@Profile(value = { ProfileConstant.TEST, ProfileConstant.DEV,
		ProfileConstant.PREPRODUCTION, ProfileConstant.PRODUCTION })
public abstract class AbstractReaderFilterConfig {
