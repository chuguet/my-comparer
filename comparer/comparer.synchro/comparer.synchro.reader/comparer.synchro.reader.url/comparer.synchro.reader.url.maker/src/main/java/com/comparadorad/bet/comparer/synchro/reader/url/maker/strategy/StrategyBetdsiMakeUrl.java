...
/**
 * The Class StrategyBetdsiMakeUrl.
 */
@Component
public class StrategyBetdsiMakeUrl extends AbstractStrategyBookmakerEuDecorator {
	...
	/**
	 * Instantiates a new strategy betdsi make url.
	 */
	public StrategyBetdsiMakeUrl() {
		dateStart = new Date();
	...
	public StrategyType getStrategyType() {
		return StrategyType.BETDSI_COM_ID;
	}
