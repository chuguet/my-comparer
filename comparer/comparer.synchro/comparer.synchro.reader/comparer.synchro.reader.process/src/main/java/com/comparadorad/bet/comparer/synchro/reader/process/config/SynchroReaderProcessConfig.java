 ...
 *
 */
package com.comparadorad.bet.comparer.synchro.reader.process.config;
...
@Import(value = { ConfigServiceConfig.class, BetServiceConfig.class,
		LogServiceConfig.class, BetBeanConfig.class, StringUtil.class })
@PropertySource({ "classpath:/process.properties" })
@ComponentScan({ "com.comparadorad.bet.comparer.synchro.reader.process" })
...
public class SynchroReaderProcessConfig {
	...
	/** The Constant FILE_ATTRIBUTE_DOZER. */
	private final static String FILE_ATTRIBUTE_DOZER = "dozer-attribute.xml";
	...
	public Mapper getMapperConfig() {
		...
		mappingFileUrls.add(FILE_ATTRIBUTE_DOZER);
