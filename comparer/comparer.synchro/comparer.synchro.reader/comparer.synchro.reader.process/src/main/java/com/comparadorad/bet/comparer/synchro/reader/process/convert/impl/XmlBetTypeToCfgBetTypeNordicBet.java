...
@Component
public class XmlBetTypeToCfgBetTypeNordicBet implements IXmlBetTypeToCfgBetType {

	/** The Constant LOG. */
	private static final Log LOG = LogFactory
			.getLog(XmlBetTypeToCfgBetTypeNordicBet.class);
	...
	public XmlBetTypeToCfgBetTypeEnum getXmlBetTypeToCfgBetTypeEnum() {
		return XmlBetTypeToCfgBetTypeEnum.NORDICBET;
	}
		...
		if (sourceObject instanceof XmlBetType) {
			...
			if (xmlBetType.getName() != null) {
				try {
					...
					// En el caso de Result, a veces se comporta como 1x2 y
					// otras como ganador partido segun el numero de apuestas.
					if (betTypeName.equals("Result")) {
