...
@Component
public class XmlBetTypeToCfgBetTypeTrioBet implements IXmlBetTypeToCfgBetType {

	/** The Constant LOG. */
	private static final Log LOG = LogFactory
			.getLog(XmlBetTypeToCfgBetTypeTrioBet.class);
	...
	public XmlBetTypeToCfgBetTypeEnum getXmlBetTypeToCfgBetTypeEnum() {
		return XmlBetTypeToCfgBetTypeEnum.TRIOBET;
	}
