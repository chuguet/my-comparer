...
@Component
public class XmlBetTypeToCfgBetTypePinnacle implements IXmlBetTypeToCfgBetType {

	/** The Constant LOG. */
	private static final Log LOG = LogFactory
			.getLog(XmlBetTypeToCfgBetTypePinnacle.class);
	...
	public XmlBetTypeToCfgBetTypeEnum getXmlBetTypeToCfgBetTypeEnum() {
		return XmlBetTypeToCfgBetTypeEnum.PINNACLE;
	}
		...
		if (sourceObject instanceof XmlBetType) {
			...
			if (xmlBetType.getName() != null) {
				try {
					...
					// En el caso de moneyline, a veces se comporta como 1x2 y
					// otras como ganador partido segun el numero de apuestas.
					if (betTypeName.equals("moneyline")) {
						if (xmlToRtResolverData.getBetsNumber() == 2) {
							betTypeName = "Match 1 2";
						} else {
