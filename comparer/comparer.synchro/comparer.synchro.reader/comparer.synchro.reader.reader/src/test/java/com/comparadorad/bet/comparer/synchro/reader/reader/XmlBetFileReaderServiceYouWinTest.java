...
import com.comparadorad.bet.comparer.model.config.repository.writer.bm.CfgBookmakerXmlReaderYouWinTestData;
...
public class XmlBetFileReaderServiceYouWinTest extends
	...
	protected CfgBookmakerXmlReader getCfgBookmakerXmlReader() {
		ICfgBookmakerXmlReaderTestData result = new CfgBookmakerXmlReaderYouWinTestData();
