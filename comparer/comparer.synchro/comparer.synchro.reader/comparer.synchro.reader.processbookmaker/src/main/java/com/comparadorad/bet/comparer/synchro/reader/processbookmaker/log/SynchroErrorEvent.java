...
final class SynchroErrorEvent implements ISynchroErrorEvent {
	 ...
	 */
	@Override
	public void errorLog(String message, @SuppressWarnings("rawtypes") AbstractXmlData xmlData, CfgBookmaker bookmaker, Date errorDate) {
		LOG.error(message);
	}
	 ...
	 */
	@Override
	public void errorLog(String pMessage, Object pData, CfgBookmaker pBookmaker, Date errorDate) {
		LOG.error(pMessage);
	}
	...
	@Override
	public void errorLog(String pMessage, Throwable pThrowable, AbstractXmlData pXmlData, CfgBookmaker pBookmaker, Date errorDate) {
	...
	@SuppressWarnings("rawtypes")
	@Override
	public void errorMasterWordsLog(String pMessage, Throwable pThrowable, AbstractXmlData pXmlData, CfgBookmaker pBookmaker, Date errorDate) {
		logXmlEventServiceMasterWords.error(READER_PROCESS, pMessage, pXmlData, pBookmaker, errorDate);
	}
