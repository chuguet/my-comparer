 ...
 *
 */
package com.comparadorad.bet.comparer.synchro.reader.processbookmaker.xml.resolver;
...
public interface IXmlToRtResolver<T extends IRtData, S extends IRtData, I extends AbstractXmlData> {
	 ...
	 */
	T resolve(I xmlData, S rtData, XmlToRtResolverData xmlToRtResolverData) throws BetBySportNotAllowedException;
