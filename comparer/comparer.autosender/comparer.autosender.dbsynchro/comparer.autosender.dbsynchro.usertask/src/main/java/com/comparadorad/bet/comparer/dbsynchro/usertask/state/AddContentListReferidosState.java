...
@Component
public class AddContentListReferidosState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(AddContentListReferidosState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.ADD_CONTENT_LIST_REFERIDOS;
	}
