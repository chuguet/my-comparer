...
/**
 * The Class AddLocationUserState.
 */
@Component
public class AddContentListBlogState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(AddContentListBlogState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.ADD_CONTENT_LIST_BLOG;
	}
