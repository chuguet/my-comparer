...
@Component
public class DeleteContentListWebPrincipalState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(DeleteContentListWebPrincipalState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.DELETE_CONTENT_LIST_WEB_PRINCIPAL;
	}
