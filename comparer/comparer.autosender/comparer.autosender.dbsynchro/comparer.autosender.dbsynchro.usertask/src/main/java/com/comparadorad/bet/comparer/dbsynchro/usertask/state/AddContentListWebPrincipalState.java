...
@Component
public class AddContentListWebPrincipalState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(AddContentListWebPrincipalState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.ADD_CONTENT_LIST_WEB_PRINCIPAL;
	}
