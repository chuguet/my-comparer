...
/**
 * The Class StartUserState.
 */
@Component
public class StartUserState extends AbstractState {

	private static final Log LOG = LogFactory.getLog(StartUserState.class);
