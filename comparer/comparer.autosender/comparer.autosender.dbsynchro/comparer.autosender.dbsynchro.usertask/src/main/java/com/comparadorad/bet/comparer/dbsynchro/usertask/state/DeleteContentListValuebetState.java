...
@Component
public class DeleteContentListValuebetState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(DeleteContentListValuebetState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.DELETE_CONTENT_LIST_VALUEBET;
	}
