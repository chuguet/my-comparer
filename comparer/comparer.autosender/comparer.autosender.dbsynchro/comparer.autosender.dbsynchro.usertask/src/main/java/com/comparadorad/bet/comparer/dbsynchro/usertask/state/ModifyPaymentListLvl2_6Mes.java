...
@Component
public class ModifyPaymentListLvl2_6Mes extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(ModifyPaymentListLvl2_6Mes.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.MODIFY_PAYMENT_LIST_LVL_2_6MES;
	}
