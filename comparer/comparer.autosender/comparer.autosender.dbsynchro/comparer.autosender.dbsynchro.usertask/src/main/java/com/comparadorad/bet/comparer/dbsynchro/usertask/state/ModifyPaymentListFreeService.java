...
@Component
public class ModifyPaymentListFreeService extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(ModifyPaymentListFreeService.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.MODIFY_PAYMENT_LIST_FREE_SERVICE;
	}
