...
@Component
public class AddContentListAfiliadosState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(AddContentListAfiliadosState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.ADD_CONTENT_LIST_AFILIADOS;
	}
