...
/**
 * The Class DeleteLocationUserState.
 */
@Component
public class DeleteContentListSurebetState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(DeleteContentListSurebetState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.DELETE_CONTENT_LIST_SUREBET;
	}
