...
@Component
public class DeleteContentListAfiliadosState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(DeleteContentListAfiliadosState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.DELETE_CONTENT_LIST_AFILIADOS;
	}
