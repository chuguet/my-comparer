...
@Component
public class ModifyPaymentListAfterFreeService extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(ModifyPaymentListAfterFreeService.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.MODIFY_PAYMENT_LIST_AFTER_FREE_SERVICE;
	}
