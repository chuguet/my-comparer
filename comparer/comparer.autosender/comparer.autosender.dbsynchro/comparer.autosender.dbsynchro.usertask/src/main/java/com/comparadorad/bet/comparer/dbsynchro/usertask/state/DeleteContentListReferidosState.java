...
@Component
public class DeleteContentListReferidosState extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(DeleteContentListReferidosState.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.DELETE_CONTENT_LIST_REFERIDOS;
	}
