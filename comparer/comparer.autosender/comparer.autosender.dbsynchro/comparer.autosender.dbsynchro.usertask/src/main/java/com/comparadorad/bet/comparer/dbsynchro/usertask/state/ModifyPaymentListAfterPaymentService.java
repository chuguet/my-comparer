...
@Component
public class ModifyPaymentListAfterPaymentService extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(ModifyPaymentListAfterPaymentService.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.MODIFY_PAYMENT_LIST_AFTER_PAYMENT_SERVICE;
	}
