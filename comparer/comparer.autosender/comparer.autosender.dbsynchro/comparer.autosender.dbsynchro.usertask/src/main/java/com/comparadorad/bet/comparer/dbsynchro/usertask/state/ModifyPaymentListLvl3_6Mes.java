...
@Component
public class ModifyPaymentListLvl3_6Mes extends AbstractState {

	private static final Log LOG = LogFactory
			.getLog(ModifyPaymentListLvl3_6Mes.class);

	@Override
	public ActionTypeName getActionType() {
		return ActionTypeName.MODIFY_PAYMENT_LIST_LVL_3_6MES;
	}
