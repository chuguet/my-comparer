/*============================================================
    "Comparer" theme programmatic settings
    Todos los cambios se han marcado con un comentario:
    "Cambiado. Valor original = x"
...
//----------------------------------------
    ...
    isc.Page.setSkinDir("[ISOMORPHIC]/skins/Comparer/");
...
//----------------------------------------
    ...
    isc.Page.loadStyleSheet("[SKIN]/skin_styles_custom.css", theWindow)
    ...
    if (useCSS3) {
        ...
        if (isc.SectionItem) {
            isc.SectionItem.addProperties({
                height:22 /*Cambiado. Valor original = 26*/
            });
        }
        if (isc.SectionStack) {
            isc.SectionStack.addProperties({
                headerHeight:22 /*Cambiado. Valor original = 26*/
            });
        }
        ...
        if (isc.TabSet) {
            isc.TabSet.addProperties({
                ...
                paneMargin:0, /*Cambiado. Valor original =  5,*/
                pickerButtonSize:20,
            ...
            isc.TabBar.addProperties({
                ...
                layoutEndMargin:0, /*Cambiado. Valor original =  5,*/
                layoutStartMargin:0, /*Cambiado. Valor original =  5,*/
                leadingMargin:0, /*Cambiado. Valor original =  5,*/
                leftStyleName:"tabBarLeft",
                membersMargin:0, /*Cambiado. Valor original =  1,*/
...
//----------------------------------------
    ...
    if (isc.SectionStack) {
        ...
        isc.ImgSectionHeader.changeDefaults("backgroundDefaults", {
            ...
            /*src:"[SKIN]SectionHeader/header.png",*/ /*Cambiado/*
            /*icon:"[SKIN]SectionHeader/opener.png",*/ /*Cambiado*/
                       /* iconSize: 16,*/ /*Cambiado*/
            capSize:2,
