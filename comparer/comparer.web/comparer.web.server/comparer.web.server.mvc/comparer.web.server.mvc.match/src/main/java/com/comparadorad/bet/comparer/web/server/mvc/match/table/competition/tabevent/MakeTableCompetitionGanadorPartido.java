...
import com.comparadorad.bet.comparer.web.server.mvc.match.table.shortterm.AbstractMakeTableDecoratorGanadorPartido_1X2Competition;

/**
 * The Class MakeTableWinnerMatch.
 */
@Component
public class MakeTableCompetitionGanadorPartido extends
		AbstractMakeTableDecoratorGanadorPartido_1X2Competition {
	 ...
	 * tabevent
	 * .AbstractMakeTableDecoratorGanadorPartido_1X2#getGreatestBets(java
	 * .util.Set)
	 */
	@Override
