 ...
 */
@Component
public class MakeTableImageSliderGanador extends AbstractMakeTableImageSlider {
	...
	public TableResponseTo getRows(CfgImageSlider view, UserData userData) {
		...
		for (RtBet bet : getBetsInOrder(market)) {
			result.add(getrow(bet, userData, false, categoryAnalytics));
		}
