...
/**
 * The Class FirstSurebetQueueProducerTest.
 */
public class FirstSurebetQueueProducerTest extends AbstractTest {
	
	/** The queue surebet. */
	@Inject
	private FirstSurebetQueueProducer<SureBetQueue> queueSurebet;
