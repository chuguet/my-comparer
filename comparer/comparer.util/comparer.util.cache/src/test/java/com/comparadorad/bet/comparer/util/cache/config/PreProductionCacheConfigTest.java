...
/**
 * The Class SpringCacheConfigurationPreProduction.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = CacheConfig.class, loader = AnnotationConfigContextLoader.class)
@ActiveProfiles(ProfileConstant.PREPRODUCTION)
public class PreProductionCacheConfigTest {
	...
	public void configTest() {
		...
		assertEquals("ehcachePreProduction.xml", resource.getFilename());
