...
@Document
public class LogEventBookmaker extends LogEvent {

	private static final Log LOG = LogFactory.getLog(LogEventBookmaker.class);
	/** The bookmaker. */
	@DBRef
	@NotNull
	 ...
	 */
	public LogEventBookmaker() {
		super();
	}

	/**
	 * Instantiates a new log event bookmaker.
	 * 
	 * @param pProcessId
	 *            the process id
	 * @param pMessage
	 ...
	 *            the log state
	 */
	public LogEventBookmaker(String pProcessId, String pMessage, Object pData,
