...
/**
 * The Interface ICfgBetTypeEventAgrupationService.
 */
public interface ICfgBetTypeEventAgrupationService extends
		IGenericCrudService<CfgBetTypeEventAgrupation> {
