 ...
 */
public enum BetTypeLuckia implements IBetType {

	/** The UN o_ x_ dos. */
	UNO_X_DOS(CfgBetTypeId.UNO_X_DOS.nameId(), "2", "9"),

	/** The GANADOR. */
	GANADOR(CfgBetTypeId.GANADOR.nameId(), "Ganador"),
	...
	MAXIMO_GOLEADOR(CfgBetTypeId.MAXIMO_GOLEADOR.nameId(),"Marcará más goles en el torneo/la liga");
	...
	public static IBetType getTypeByValue(String pValue) {
		BetTypeLuckia[] values = BetTypeLuckia.values();
