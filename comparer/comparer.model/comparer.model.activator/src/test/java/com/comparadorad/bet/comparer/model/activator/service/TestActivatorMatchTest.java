...
/**
 * The Class TestActivatorMatchTest.
 */
public class TestActivatorMatchTest extends ActivatorMatchTest {
	
	/** The activator match. */
	@Inject
	private TestActivatorMatch testActivatorMatch;
	...
	public void executeOneElementTest() {
		...
		assertNotNull(testActivatorMatch);

		result = testActivatorMatch.execute(match, Boolean.TRUE);
	...
	public void executeSeveralElementTest() {
		...
		result = testActivatorMatch.execute(matchs, Boolean.TRUE);
